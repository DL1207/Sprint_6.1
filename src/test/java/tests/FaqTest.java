...
public class FaqTest {
    ...
    private static Stream<Arguments> provideFaqData() {
        return Stream.of(
    ...
    @ParameterizedTest
    @MethodSource("provideFaqData")
    public void testFaqQuestions(int questionNumber, String expectedAnswer) {
        String actualAnswer = mainPage.getAnswer(questionNumber);
        assertEquals(expectedAnswer, actualAnswer,
                "Ответ на вопрос " + questionNumber + " не совпадает");
    }
}